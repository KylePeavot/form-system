      ...
      <div class="flex items-center h-16">
        <div class="flex items-center">
          ...
          <div class="md:block flex justify-end">
            <div class="ml-10 space-x-4 justify-end flex">
              <div v-for="(value, index) in pages" :key="`${value[0]}-${index}`">
                  <span>
                    <NavbarItem :primary-route="value[1]" :is-selected="isPageSelected(value[1])" />
                  </span>
              </div>
            </div>
          </div>
